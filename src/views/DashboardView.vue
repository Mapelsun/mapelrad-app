...
<template>
  <dashboard-layout>
    <div class="p-4 bg-accent-gray-100 rounded-[20px] w-full h-min">
      <h3 class="font-semibold text-2xl mb-2">Hello!<br>Let’s get you set up</h3>

      <progress-bar :currentStep="currentStep" />
